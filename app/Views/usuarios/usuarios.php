                        ...
                        <tbody>
                            <?php foreach ($datos as $dato) { ?>
                                <tr>
                                    ...
                                    ['id']; ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a> </td>

                                    <td><button data-bs-id="<?php echo $dato['id'] ?>" data-bs-nombreid="<?php echo $dato['nombre'] ?>"
                                     data-bs-toggle="modal" data-bs-target="#modalconfirma" class="btn btn-danger">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form id="modelForm" data-bs-action="<?php echo base_url(). '/usuarios/eliminar/'?>" action="" method="post" >
